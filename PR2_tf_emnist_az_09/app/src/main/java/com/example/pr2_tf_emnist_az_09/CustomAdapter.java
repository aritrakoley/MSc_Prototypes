...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.CustomViewHolder> {
    ...
    public CustomAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        if(i == Item.SMALL) // i is viewType
            itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item_small, viewGroup, false);
        else
            itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item_big, viewGroup, false);
